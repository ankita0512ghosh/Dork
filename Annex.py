...
class News:
    ...
    def show(self):
        ...
        r=requests.get('http://newsapi.org/v2/top-headlines?country=in&apiKey=3a176281c5394c97988b7ada5cb8b4fe')
...
class Weather:
    def show(self,scrollable_text):
        SR=SpeakRecog(scrollable_text)
        base_url = "http://api.openweathermap.org/geo/1.0/zip?zip=110075,IND&appid=58bb081f22fea521a4a3cd7ccb24aa88"
