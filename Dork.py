...
try:
    app=wolframalpha.Client("GGE294-85YWVL9RXL")  #API key for wolframalpha
...
def greet():
    ...
    SR.speak("\nMyself Dork. How may I help you?")
    ...
    try:
        while(True):
            ...
            #asking for name
                ...
                SR.speak("My name is Dork and I'm here to serve you.")
            #How are you
            ...
            #bluetooth file sharing
                ...
                os.startfile(r"C:\Windows\WinSxS\wow64_microsoft-windows-bth-user_31bf3856ad364e35_10.0.22000.653_none_6ab5b5b48ed1e6d8\fsquirt.exe")
                break
            ...
            #opening software applications
                ...
                codepath=r"C:\Users\Ankita ghosh\Downloads\VSCodeUserSetup-x64-1.71.2.exe"
                ...
                os.startfile("C:\Windows\WinSxS\amd64_microsoft-windows-explorer-shortcuts_31bf3856ad364e35_10.0.22000.778_none_b2ef18ec963ad3d0\File Explorer.lnk")
                break
            elif there_exists(['powershell'],query):
                SR.speak("Opening powershell")
                os.startfile(r"C:\Windows\SysWOW64\WindowsPowerShell\v1.0\powershell.exe")
                break
